...
// doubleArray deve applicare la funzione di callback a ciascun elemento dell'array e restituire 
// un nuovo array con i valori trasformati.

function doubleArray(arr, callback) {
    const result = arr.map(element => callback(element))
    return result;
  }
